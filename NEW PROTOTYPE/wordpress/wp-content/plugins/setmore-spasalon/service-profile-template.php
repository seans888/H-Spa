    ...
    <div id="content" class="clearfix">
        ...
        <div id="main" class="clearfix" role="main">
        	...
        	<?php 
				...
				$setmore_spasalon_service_query = new WP_Query($setmore_spasalon_args);
			?>
            
			<?php if ( $setmore_spasalon_service_query->have_posts() ) : ?>
            	<div id="grid-wrap" class="services-wrap clearfix">
				<?php /* Start the Loop */ ?>
				<?php while ( $setmore_spasalon_service_query->have_posts() ) : $setmore_spasalon_service_query->the_post(); ?>
