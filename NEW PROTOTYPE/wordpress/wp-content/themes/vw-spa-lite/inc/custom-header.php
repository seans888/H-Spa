...
function vw_spa_lite_custom_header_setup() {
	...
	add_theme_support( 'custom-header', apply_filters( 'vw_spa_lite_custom_header_args', array(
		...
		'width'                  => 1600,
		'height'                 => 400,
		'wp-head-callback'       => 'vw_spa_lite_header_style',
	) ) );
...
if ( ! function_exists( 'vw_spa_lite_header_style' ) ) :
...
function vw_spa_lite_header_style() {
...
endif; // vw_spa_lite_header_style

add_action( 'admin_head', 'vw_spa_lite_admin_header_css' );
function vw_spa_lite_admin_header_css(){ ?>
